...
public class MoblieUserSignController {
    ...
    public MoblieUserSignController(AuthenticationManager authenticationManager, JwtUtil jwtUtil) {
    ...
    public String registerUser(@ModelAttribute User user) {
        ...
        return "redirect:/Mobile/Users/LoginForm";
    }
    /*========================================================*/
	...
	public ResponseEntity<String> logout(HttpServletResponse response, HttpSession session, HttpServletRequest request) {
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("jwt")||cookie.getName().equals("userJwt")||cookie.getName().equals("kakaoAccessToken")) {
                    ...
                    cookie.setPath("/Mobile/Users/Main");
		...
		userJwtCookie.setPath("/Mobile/Users/Main");
        ...
        kakaoAccessTokenCookie.setPath("/Mobile/Users/Main"); // 쿠키 경로 설정
