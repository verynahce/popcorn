    ...
    public List<Map<String, Object>> getPopupList() {
        ...
        for (UsersDto popup : popupList) {
            try {
                ...
                data.put("address", popup.getAddress());
                data.put("like_count", popup.getLike_count());
                System.out.println(" popup.getAddress()"+ popup.getAddress());
                System.out.println("popup.getLike_count()"+popup.getLike_count());
